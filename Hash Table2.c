			...
			case 2:
		  	...
		  	case 3:
				...
				fclose(archivo);
		  		...
		  		printf(">>%i\n", hashTable[(int)fabs(funHash("kú") % HASH_SIZE)].data);
		  		printf(">>%i\n", hashTable[(int)fabs(funHash("kú") % HASH_SIZE)].next->data);
		  		printf(">>%i\n", hashTable[(int)fabs(funHash("kú") % HASH_SIZE)].next->next->data);
		  		printf(">>%i\n", hashTable[(int)fabs(funHash("kú") % HASH_SIZE)].next->next->next->data);
